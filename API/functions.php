...
define('COMPANY_ADDRESS_1','80 M.9 Phaholyothin Rd.');
define('COMPANY_ADDRESS_2','Tambol BAAN-DOO');
define('COMPANY_ADDRESS_3','CHIANGRAI ');
define('COMPANY_COUNTY','THAILAND');
define('COMPANY_POSTCODE','57100');
...
// EMAIL DETAILS
define('EMAIL_FROM', 'admin@cit6001.com'); // Email address invoice emails will be sent from
...
define('TIMEZONE', 'America/Los_Angeles'); // Timezone - See for list of Timezone's
...
define('PAYMENT_DETAILS', 'Invoice Mg System.<br>Sort Code: 00-00-00<br>Account
Number: 12345678'); // Payment information
