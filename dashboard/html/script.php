...
$(document).ready(function() {
    ...
    $(document).on('click', ".delete-customer", function(e) {
        ...
        var userId = 'action=delete_customer&delete=' + $(this).attr(
        'data-customer-id'); //build a post data structure
        var user = $(this);
    ...
    $(document).on('click', ".email-invoice", function(e) {
        ...
        var invoiceId = 'action=email_invoice&id=' + $(this).attr('data-invoice-id ') + ' & email = ' +
            $(this).attr('data - email ') + ' & invoice_type = ' + $(this).attr(
            'data - invoice -type ') + ' & custom_email = ' + $(this).attr(
            'data - custom - email '); //build a post data structure
    ...
    $(document).on('click', ".delete-invoice", function(e) {
        ...
        var invoiceId = 'action=delete_invoice&delete=' + $(this).attr(
        'data-invoice-id'); //build a post data structure
        var invoice = $(this);
    ...
    $(document).on('click', ".delete-product", function(e) {
        ...
        var productId = 'action=delete_product&delete=' + $(this).attr(
        'data-product-id'); //build a post data structure
        ...
        if (errorCounter > 0) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $("#response .message").html("<strong>" + data.status +
                ...
                error: function(data) {
                    ...
                    $("#response").removeClass("alert-success ").addClass("alert - warning ")
                        .fadeIn();
